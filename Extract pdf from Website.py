...
extract_url_pdf(input_url="https://fin.assam.gov.in/assamfinance/secure/getCreatedGIABills")
...
# In[ ]:https://fin.assam.gov.in/assamfinance/secure/getCreatedGIABills
